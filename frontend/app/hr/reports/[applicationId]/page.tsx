...
import { DLScoresCard } from "@/components/hr/DLScoresCard";
      ...
      {report && (
        <>
          ...
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
            ...
            {report.dl_scores && (
                <DLScoresCard scores={{
                  dl_scores: report.dl_scores.dl_scores,
                  maturity_band: report.dl_scores.maturity_band,
                  overall_dl_score: report.dl_scores.overall_dl_score,
                  authenticity_score: report.dl_scores.authenticity_score,
                  modality_contributions: report.dl_scores.modality_contributions,
                  model_used: report.dl_scores.model_used,
                }} />
              )}
          </div>
        </>
